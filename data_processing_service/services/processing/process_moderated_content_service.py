...
from data_processing_service.services.processing.youtube.process_moderated_youtube_content_service import ProcessModeratedYoutubeContentService
...
class ProcessModeratedContentService:
    ...
    def __init__(self):
        ...
        self.youtube_content_service = ProcessModeratedYoutubeContentService(user_content_repository)
