...
from data_processing_service.services.processing.youtube.ai_agent.models.input import ContentDataInput, SubtitleDataInput
from typing import Optional, List

class ContentInputAdaptor:
    @staticmethod
    def from_youtube_details_and_subtitle_map(youtube_video_details: YouTubeVideoDetails, subtitle_map: SubtitleMap) -> ContentDataInput:
        subtitle_data_input = SubtitleDataInput(
            language=subtitle_map.language,
            subtitle_string=subtitle_map.subtitle
        )
        return ContentDataInput(
            ...
            categories=youtube_video_details.categories[:5] if youtube_video_details.categories else [],
