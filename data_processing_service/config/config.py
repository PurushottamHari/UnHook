"""
Configuration management for data processing service.
"""
...
class Config:
    """Configuration class for data processing service."""
    ...
    def service_name(self) -> str:
        """Get service name."""
        return self._config_data.get("service", {}).get("service_name", "data-processing-service")

    @property
    def service_port(self) -> int:
        """Get service port."""
        return self._config_data.get("service", {}).get("service_port", 8002)
