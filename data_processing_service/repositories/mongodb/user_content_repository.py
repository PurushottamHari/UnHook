...
from data_processing_service.repositories.mongodb.adapters.generated_content_adapter import GeneratedContentAdapter
...
class MongoDBUserContentRepository(UserContentRepository):
    ...
    def get_user_collected_content_without_generated_content(
        ...
        generated_external_ids = set(
            doc["external_id"]
            for doc in self.generated_content_collection.find({"content_type": content_type}, {"external_id": 1})
        )
    ...
    def add_generated_content(self, generated_content: GeneratedContent):
        generated_content_db_model = GeneratedContentAdapter.to_generated_content_db_model(content=generated_content)
        # Insert the generated content into the generated_content_collection
        self.generated_content_collection.insert_one(generated_content_db_model.model_dump(by_alias=True))