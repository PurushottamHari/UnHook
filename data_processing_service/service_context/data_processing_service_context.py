"""
Base service context for data processing services.
"""
...
class DataProcessingServiceContext(BaseServiceContext):
    """
    Base service context for all data processing services.

    Provides common functionality that processing services can use.
    ...
    def __init__(
        ...
        """
        Initialize the data processing service context.
    ...
    def _initialize_metrics_processor(
        ...
        try:
            ...
            if pipeline_id:
                ...
                print(f"✅ Metrics processor initialized for pipeline: {pipeline_id}")
            else:
                print("⚠️  No pipeline ID found - metrics collection disabled")
        except Exception as e:
            print(f"⚠️  Failed to initialize metrics processor: {e}")
