...
import { WaitlistFormData, WaitlistSubmissionResult } from '@/lib/services/waitlist-service';
...
export default function WaitlistForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result: WaitlistSubmissionResult = await response.json();
      ...
      if (result.success) {
        ...
        if (result.error?.includes('already exists')) {
          setSubmitMessage('You are already on our waitlist!');
        } else {
