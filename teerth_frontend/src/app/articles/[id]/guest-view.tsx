...
export default function GuestView({ articleId }: { articleId: string }) {
  ...
  if (error && !displayArticle) {
    return (
      <div className="min-h-screen bg-yellow-50 dark:bg-amber-50 relative">
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 py-8 mt-6">
  ...
  if (article === null && !isLoading && !isFetching && !placeholderData) {
    return (
      <div className="min-h-screen bg-yellow-50 dark:bg-amber-50 flex items-center justify-center relative">
        <ModeBanner mode="guest" />
  ...
  return (
    <div className="min-h-screen bg-yellow-50 dark:bg-amber-50 relative">
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-8 pt-12">
        ...
        {/* Waitlist Section only visible in guest mode */}
