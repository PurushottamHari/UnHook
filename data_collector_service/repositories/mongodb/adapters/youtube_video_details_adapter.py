...
class YouTubeVideoDetailsAdapter:
    """Adapts between YouTubeVideoDetails and YouTubeCollectedContentDBModel."""

    @staticmethod
    def to_db_model(entity: YouTubeVideoDetails) -> YouTubeCollectedContentDBModel:
        """Convert YouTubeVideoDetails to YouTubeCollectedContentDBModel."""
        return YouTubeCollectedContentDBModel(
            ...
            status_details=[
                YouTubeVideoStatusDetailDB(
                    ...
                    created_at=YouTubeVideoDetailsAdapter._datetime_to_float(
                        detail.created_at
                    ),
    ...
    def from_db_model(db_model: YouTubeCollectedContentDBModel) -> YouTubeVideoDetails:
        """Convert YouTubeCollectedContentDBModel to YouTubeVideoDetails."""
        return YouTubeVideoDetails(
            ...
            status_details=[
                YouTubeVideoStatusDetail(
                    ...
                    created_at=YouTubeVideoDetailsAdapter._float_to_datetime(
                        detail.created_at
                    ),
                    reason=detail.reason,
                )
