...
from ....models.user_collected_content import UserCollectedContent, ContentStatus, StatusDetail
...
class YouTubeToUserContentAdapter:
    ...
    @staticmethod
    def convert_batch(videos: List[YouTubeVideoDetails], user_id: str) -> List[UserCollectedContent]:
        """
