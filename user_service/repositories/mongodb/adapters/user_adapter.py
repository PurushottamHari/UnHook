...
class UserAdapter:
    ...
    @staticmethod
    def _to_not_interested_db_model(
        not_interested: NotInterested,
    ) -> NotInterestedDBModel:
    ...
    @staticmethod
    def _to_youtube_channel_config_db_model(
        config: YoutubeChannelConfig,
    ) -> YoutubeChannelConfigDBModel:
        ...
        return YoutubeChannelConfigDBModel(
            ...
            not_interested=(
                [
                    UserAdapter._to_not_interested_db_model(n)
                    for n in config.not_interested
                ]
                if config.not_interested
                else None
            ),
    ...
    def _to_youtube_config_db_model(config: YoutubeConfig) -> YoutubeConfigDBModel:
        ...
        return YoutubeConfigDBModel(
            ...
            channels=[
                UserAdapter._to_youtube_channel_config_db_model(c)
    ...
    def _to_not_interested_model(db_model: NotInterestedDBModel) -> NotInterested:
        ...
        return NotInterested(category_definition=db_model.category_definition)

    @staticmethod
    def _to_youtube_channel_config_model(
        db_model: YoutubeChannelConfigDBModel,
        ...
        return YoutubeChannelConfig(
            ...
            not_interested=(
                [
                    UserAdapter._to_not_interested_model(n)
                    for n in db_model.not_interested
                ]
                if db_model.not_interested
                else []
            ),
            output_type=OutputType(db_model.output_type),
        )
    ...
    def _to_youtube_config_model(db_model: YoutubeConfigDBModel) -> YoutubeConfig:
        ...
        return YoutubeConfig(
            ...
            channels=[
                UserAdapter._to_youtube_channel_config_model(c)
                for c in db_model.channels
            ],
        )
